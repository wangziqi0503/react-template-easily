...
(function (window, document) {
  ...
  // 计算地图上两个坐标点之间的距离
  common.getDistance = (sSrcPointX, sSrcPointY, sDesPointX, sDesPointY) => Math.sqrt(Math.pow(sDesPointX - sSrcPointX, 2) + Math.pow(sDesPointY - sSrcPointY, 2));
  ...
  // 获取URL参数
  common.fetchNAParams = () => new Promise((resolve) => {
