...
class ImageSlider extends Component {
  constructor(props) {
    ...
    refreshContainerWidth() {
      ...
      const imgContainerWidth = viewWidth - 2 * this.imgSlider.offsetLeft;
    ...
    render() {
      ...
      if (hasContent) {
        scrollViewProps = {
          ...
          onScrollStart: () => {
            const curPage = this.imgeSliderScrollView.getIScrollInstance().currentPage.pageX;
            this.myUl.style.paddingRight = 0;
            this.imgSlider.style.left = '';
            this.imgSlider.style.marginLeft = '';
            this.imgeSliderScrollView.refresh();
                    ...
                    (() => {
                      if (hasContent) {
                        ...
                        return this.props.showIndicator ? (
                          <div id="indicator" style={{ width: indicatorContainerWidth }}>
                            <div id="dotty" />
                          </div>
                        ) : '';
                      }
...
const Image = ({ srcUlr }) => (<div><img src={srcUlr} /></div>);
