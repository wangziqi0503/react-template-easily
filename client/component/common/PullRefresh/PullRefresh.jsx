...
const PullRefresh = React.createClass({
  ...
  touchMove(event) {
    ...
    if (document.body.scrollTop == 0) {
      ...
      } else if (self.joinRefreshFlag == null) {
  ...
  render() {
    ...
    return (
      <div className="pull-down-content">
        <span className={`icon ${this.pullDownIcon[status]}`} />
