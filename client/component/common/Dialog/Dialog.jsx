...
class Dialog extends Component {
  constructor(props) {
    ...
    render() {
      // 组件属性
      const {
        btn1_text, btn2_text, dialog_status, status_title, status_content,
      } = this.props;
      ...
      return (
        <div className="com_dialog" onTouchMove={(e) => { e.preventDefault(); }} style={{ width: window.innerWidth, height: window.innerHeight }}>
          <div className="dialog_mask" onTouchMove={(e) => { e.preventDefault(); }} />
...
export default {
  /**
     ...
     */
  dialogInstance(dialog_status, status_title, status_content, btn1_text, btn1_callBack, btn2_text, btn2_callBack, closed_callBack) {
