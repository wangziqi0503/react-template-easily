...
class Collapse extends Component {
  constructor(props) {
    ...
    render() {
      const FoldclassName = this.state.isFold ? 'fold' : 'unfold';
      const dir = this.state.isFold ? 'down' : 'up';
      const {
        showTitle, collapseTitle, className, duration, motion,
      } = this.props;
      const title = this.state.isFold ? showTitle : collapseTitle;
      return (
        <div className={`frc_collapse_container ${FoldclassName} ${className}`}>
          ...
          <footer
            className={`frc_collapse_footer ${FoldclassName}`}
          ...
          >
            ...
            <div className={`frc_collapse_icon arrow-${dir}`} />
          </footer>
        </div>
      );
    }
