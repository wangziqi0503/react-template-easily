    ...
    render() {
      ...
      return (
        <div className={`frc_menu_container ${className || ''}`}>
          ...
          {this.state.showList ? <div style={{ width: this.clientWidth, height: this.clientHeight }} className="frc_menu_layer" onClick={this.closeMenu.bind(this)} onTouchMove={(e) => { e.stopPropagation(); }} /> : ''}
        </div>
      );
    }
}

const MenuItem = (props) => <li {...props}>{props.children}</li>;
